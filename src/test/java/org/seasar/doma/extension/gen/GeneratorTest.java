...
public class GeneratorTest extends TestCase {
  ...
  public void testSelectById() throws Exception {
    ...
    SqlDesc sqlDesc = sqlDescFactory.createSqlDesc(entityDesc, "dummy", "selectById.sql.ftl");
  ...
  public void testSelectById_entitySuperclass_columnNotFound() throws Exception {
    ColumnMeta id = new ColumnMeta();
    id.setComment("COMMENT for ID");
    id.setName("ID");
    id.setTypeName("integer");
  ...
  public void testSimpleSqlTest() throws Exception {
    ...
    SqlTestCaseDescFactory sqlFileTestDescFactory =
        factory.createSqlTestCaseDescFactory(
            "org.seasar.doma.jdbc.dialect.StandardDialect",
            "org.hsqldb.jdbcDriver",
            "jdbc:hsqldb:mem:example",
            "sa",
            "");
    SqlTestCaseDesc sqlTestCaseDesc =
  ...
  public void testSelectByIdAndVersion() throws Exception {
    ...
    SqlDescFactory sqlDescFactory = factory.createSqlDescFactory(null, dialect);
    SqlDesc sqlDesc =
        sqlDescFactory.createSqlDesc(entityDesc, "dummy", "selectByIdAndVersion.sql.ftl");
  ...
  private String expect() {
    ...
    String path = getClass().getName().replace(".", "/") + "_" + getName().substring(4) + ".txt";
